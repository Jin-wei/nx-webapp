    ...
    <div class="">
        <section class="content-header">
            <ol class="breadcrumb">
                ...
                <li class="active">短信月账单统计</li>
            </ol>
        </section>

        <section class="content chart-session-margin">
            <div class="row">
                <div class="col-md-12">
                    <div class="">
                        <div class="box-body country-padding" style="min-height: 65px;">
                            <form class="form-horizontal">
                                <div class="form-group " style="margin-left: -40px">
                                    <label class="col-sm-1 control-label input-sm ">自然月</label>
                                    <div class="col-sm-2">
                                        <input type="text"  id="month"    class="form-control input-sm browse">
                                    </div>
...
<script>
    ...
    var  urlApi='/api/admin/chart_month?method=';
    export default {
        data: function () {
            return {
        ...
        methods: {
            getData:function () {
                ...
                _self.$http.post(urlApi+'getMonthReportAdmin',params).then((response)=>{
                    if(response.data.errno==0){
                        ...
                        common.dealConsolError(_self,response,1);
                    }
                },(response)=>{
                    common.dealConsolError(_self,response,1);
                })
            ...
            exportExl:function () {
                ...
                params=JSON.stringify(params);
                common.downFile(_self,urlApi+'downloadMonthReportAdmin',params);
            },
        },
