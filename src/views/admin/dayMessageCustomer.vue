...
<script>
    ...
    const apiUrl = '/api/admin/dayMessageCustomer?method='
    var sumArry='';
    ...
    export default {
        ...
        mounted: function() {
            ...
            function actFormatter(value) {
                ...
                return [
                    '<a class="turnMessage" title="跳转">' + customer + '</a>'
                ].join('')
            }
            ...
            function initTable() {
                window.tableEvents = {
                    'click .turnMessage': function(e, value, row, index) {
                        ...
                        common.setStoreData('customer',value);
                ...
                $('#table').bootstrapTable({
                    method: 'POST',
                    url: apiUrl + 'getDayReportCustomer',
                    ...
                    columns: [
                        ...
                        common.actFormatterTitle('real_name', '客户', actFormatter,tableEvents),
        ...
        methods: {
            ...
            exportExl:function () {
                ...
                common.downFile(_self,apiUrl+'downloadDayReportCustomer',params);
            },
        }
