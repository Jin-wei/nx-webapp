    ...
    <div>
        ...
        <section class="content body-session-margin">
            <div class="row">
                <div class="col-md-12">
                    <div class="">
                        <div class="box-body country-padding" style="min-height: 110px;">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-1 control-label input-sm">浮动标志</label>
                                    <div class="col-sm-2">
                                        <select class="form-control" v-model="searchData.floatFlag" >
                                    ...
                                    <label  class="col-sm-1 control-label input-sm">生效日期</label>
                                    <div class="col-sm-5">
                                        <div class="">
...
<script>
    ...
    const apiUrl = '/api/admin/supplierDetailCustomer?method='
    ...
    export default {
        ...
        mounted: function() {
            ...
            function queryParams(params) {
                params.effectiveDateBegin= $('#start_date').val();
                params.effectiveDateEnd= $('#end_date').val();
                params.code =_self.searchData.code;
                params.floatFlag =_self.searchData.floatFlag;
            ...
            function initTable() {
                $('#table').bootstrapTable({
                    ...
                    columns: [
                        ...
                        common.BTRowFormat('price', '价格'),
                        common.BTRowFormat('effectiveDate', '生效日期'),
                        common.BTRowFormatWithFormatter('float_flag', '浮动标志',flagFormatter),
                    ],
                    idField: 'id',
                    uniqueId: 'id',
                    clickToSelect: true,
        ...
        methods: {
            ...
            returnPage:function () {
                let _self=this;
                this.$router.push({path:'/admin/supplierCustomer'});
            },
