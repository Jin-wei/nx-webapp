                        ...
                        <div class="box-body" style="min-height: 147px">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-1 control-label input-sm">证件类型</label>
                                    <div class="col-sm-2">
                                        <select class="form-control" v-model="searchData.idType">
                                            <option value="">全部</option>
                                            <option value="0">身份证</option>
                                            <option value="1">护照</option>
                                        </select>
                                    </div>
                                    <label class="col-sm-1 control-label input-sm">证件号码</label>
                                    <div class="col-sm-2">
                                        <input v-model="searchData.idNo" type="number" class="form-control input-sm"  oninput="if(value.length>30)value=value.slice(0,20)">
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal-dialog" style="width: 800px;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">个人客户详情</h4>
                    </div>
                    <form id="formA">
                        <div class="modal-body" style="min-height: 530px">
                            ...
                            <div class="form-group  col-md-4">
                                <label>证件类型</label>
                                <input class="form-control" v-model="detailData.id_type" disabled>
                            </div>
                            <div class="form-group  col-md-4">
                                <label>证件号</label>
                                <input class="form-control" v-model="detailData.id_no" disabled>
                            </div>
                            <div class="form-group  col-md-4">
                                <label>审批状态</label>
        ...
        <div class="modal fade" id="AddModal2">
            <div class="modal-dialog" style="">
                <div class="modal-content">
                    ...
                    <form @submit.prevent="examinePost(detailData.id,2)" id="personModel">
                        <div class="modal-body" style="min-height: 100px">
                            <div class="form-group col-md-12">
                                <label >驳回原因</label>
                                <input v-model="approvalText" class="form-control col-md-8"  data-parsley-required="true"  maxlength="50" data-parsley-maxlength="50">
                            </div>
                        </div>
                        <div class="modal-footer">
...
<script>
    ...
    const apiUrl = '/api/admin/personCustomer?method='
    ...
    export default {
        ...
        mounted: function() {
            ...
            function queryParams(params) {
                ...
                params.idNo=_self.searchData.idNo;
                params.idType=_self.searchData.idType;
            ...
            function initTable() {
                ...
                $('#table').bootstrapTable({
                    ...
                    columns: [
                        ...
                        common.BTRowFormat('real_name', '真实名称'),
                        common.BTRowFormatWithFormatter('id_type', '证件类型',idTypeFormatter),
                        common.BTRowFormat('id_no', '证件号码'),
...
//                        common.BTRowFormatWithFormatter('c_time', '申请认证时间',timeFormatter),
                        ...
                        /*common.BTRowFormatWithFormatter('id_photo', '图片',common.imagesFormatter,tableEvents),*/
        ...
        methods: {
                ...
                _self.$http.post(apiUrl + 'getAllCustomer',{id:id}).then((response) => {
                    if(response.data.errno==0){
                        if(response.data.info.rows.length>0){
                            ...
                            _self.detailData.id_type=idTypeFormatter(_self.detailData.id_type);
            ...
            examinePost:function (id,status) {
                ...
                if(status==2){
                    ...
                    if ($('#personModel').parsley().isValid()) {
