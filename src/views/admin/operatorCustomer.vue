                    ...
                    <div class="box-body" style="min-height: 70px">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input v-model="searchData.code" type="text" class="form-control input-sm"  oninput="if(value.length>30)value=value.slice(0,30)" >
                                </div>
...
<script>
    ...
    const apiUrl = '/api/admin/operatorCustomer?method='
    ...
    export default {
        ...
        mounted: function() {
            ...
            function queryParams(params) {
                ...
                params.operatorName=_self.searchData.name;
            ...
            function initTable() {
                ...
                $('#table').bootstrapTable({
                    method: 'POST',
                    url: apiUrl + 'getAllVendorFeeDetail',
                    ...
                    columns: [
                        ...
                        common.BTRowFormat('code', '国码'),
                        common.BTRowFormat('countryName', '国家名称'),
                        common.BTRowFormat('operatorName', '运营商名称'),
                        common.BTRowFormatWithFormatter('c_price', '当前价格',priceFormat),
                        common.BTRowFormatWithFormatter('f_price', '生效价格',priceFormat),
                        common.BTRowFormat('effective_date', '生效日期'),
