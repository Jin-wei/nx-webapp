                        ...
                        <form class="form-horizontal">
                            <div class="day-border">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text"  class="form-control" id="vendor" oninput="if(value.length>30)value=value.slice(0,30)" v-on:keyup="getVendor"/>
                                    </div>
...
<script>
    ...
    const apiUrl = '/api/admin/dayMessageSupplier?method='
    ...
    export default {
            ...
            function initTable() {
                window.tableEvents = {
                    'click .turnMessage': function(e, value, row, index) {
                        ...
                        common.setStoreData('vendorName',value);
                ...
                $('#table').bootstrapTable({
                    ...
                    columns: [
                        ...
                        common.actFormatterTitle('vendorName', '供应商', actFormatter,tableEvents),
                        common.BTRowFormatFooter('allTotalSize', '总发送数量',allTotalSize),
                        common.BTRowFormatFooter('succTotalSize', '总发送成功数量',succTotalSize),
                        common.BTRowFormatFooter('failTotalSize', '总发送失败数量',failTotalSize),
        ...
        methods: {
            ...
            getVendor:function () {
                ...
                common.fuzzySearch(_self,'vendor',apiUrl + 'getVendor',params);
            ...
            exportExl:function () {
                ...
                common.downFile(_self,apiUrl+'downloadDayReportVendor',params);
            },
        }
