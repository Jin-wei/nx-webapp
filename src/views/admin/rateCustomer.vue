...
<script>
    ...
    const apiUrl = '/api/admin/rateCustomer?method='
    ...
    export default {
        ...
        mounted: function() {
            ...
            function queryParams(params) {
                ...
                params.realName=_self.searchData.name;
                params.type=0;
            ...
            function initTable() {
                window.tableEvents = {
                    ...
                    'click .btn-detail': function(e, value, row, index) {
                        _self.$router.push({path: '/admin/rateDetailCustomer', query: {id: row.id}})
                    }
